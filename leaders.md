...
layout: page
title: Leaders
subtitle: Leadership in neurosurgery, neuro-oncology, and tumor immunotherapy
---
...
<div class="leaders-grid">
    <div class="leader-card">
        <div class="leader-meta">
            ...
            <a class="leader-link" href="#zhan-renya">View full profile →</a>
        </div>
    </div>
    <div class="leader-card">
        <div class="leader-meta">
...
<div id="zhan-renya" class="leader-profile">
    <div class="profile-photo">
        <img src="{{ '/assets/images/ZhanRenya.jpg' | relative_url }}" alt="Professor Zhan Renya portrait">
    </div>
    <div class="profile-body">
        ...
        <h4>Clinical & Research Expertise</h4>
        <ul>
...
<div id="jin-linchun" class="leader-profile">
    <div class="profile-photo">
